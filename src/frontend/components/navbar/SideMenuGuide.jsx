  ...
  return (
    <div className ="side-navbar-wrapper">
       ...
       <div className = {`side-navbar-content ${singlePage && "singlepage-sidebar"} ${theme}`}>
            ...
            <NavLink to = "/LikedVideo" className = {!singlePage && (({isActive}) => isActive ? "link-active":"link-inactive")}><i className="fas fa-thumbs-up sidebar-icon" title = {singlePage ? "Liked Videos" :""}></i>{ !singlePage && "Liked Videos" }</NavLink>
            <NavLink to = "/History" className = {!singlePage && (({isActive}) => isActive ? "link-active":"link-inactive")}><i className="fas fa-history sidebar-icon" title = {singlePage ? "History" :""}></i>{!singlePage && "History"}</NavLink>
            <NavLink to = "/Playlist" className = {!singlePage && (({isActive}) => isActive ? "link-active":"link-inactive")}><i className="far fa-hdd sidebar-icon" title = {singlePage ? "Playlist" :""}></i>{!singlePage && "Playlist"}</NavLink>
        </div>
    </div>
  )
}
